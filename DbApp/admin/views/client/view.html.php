...
class DbAppViewClient extends JView {
	...
	protected function addToolBar() {
		...
		JToolBarHelper::title($isNew ? JText::_('New Client') : JText::_('Edit Client'), 'Client');
	...
	protected function setDocument() {
		...
		$document->setTitle($isNew ? JText::_('Create Client') : JText::_('Edit Client'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root());
		JText::script('Client Unacceptable <some strange fields???>');
	}
