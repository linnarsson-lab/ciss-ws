...
namespace Linnarsson.Dna
{
    ...
    public sealed class Props
    {
        ...
        public string BowtieMultiOptions = "--phred64-quals -a -v 3 -M <BowtieMaxNumAltMappings> --best --strata";
        public int BowtieMaxNumAltMappings = 10; // Value to replace in BowtieMultiOptions
