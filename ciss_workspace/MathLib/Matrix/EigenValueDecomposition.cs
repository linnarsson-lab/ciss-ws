...
namespace Linnarsson.Mathematics
{
	...
	public class EigenvalueDecomposition
	{
		...
		private MatrixDouble V; 			// storage of eigenvectors.
		private MatrixDouble H;  			// storage of nonsymmetric Hessenberg form.
		...
		public MatrixDouble EigenvectorMatrix
		{
			get
			{
				return this.V;
		...
		public MatrixDouble DiagonalMatrix
		{
			get
			{
